...
<div>
  <h3>PEER</h3> <span>
    <svg width="26" height="26" viewBox="0 0 512 512"><circle cx="256" cy="256" r="64" fill="currentColor"/>
  ...
  <h3 class="reverse-gradient">SHARE</h3>
</div>
...
h3{
  background: -webkit-linear-gradient(183deg, var(--primary-dark) 22%, #5b5b5b 66%);  
...
h3.reverse-gradient{
  background: -webkit-linear-gradient(0deg, var(--primary-dark) 22%, #5b5b5b 66%);  
  -webkit-background-clip: text;
  background-clip: text;
}
svg{
